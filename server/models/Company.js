...
const companySchema = new mongoose.Schema({
  ...
  dashboardState: { type: mongoose.Schema.Types.Mixed, default: () => buildDefaultCompanyDashboardState() },
  gigManagementState: { type: mongoose.Schema.Types.Mixed, default: () => buildDefaultCompanyGigManagementState() },
  projectWorkspaceState: { type: mongoose.Schema.Types.Mixed, default: () => buildDefaultCompanyWorkspaceState() },
  paymentState: { type: mongoose.Schema.Types.Mixed, default: () => buildDefaultCompanyPaymentState() },
